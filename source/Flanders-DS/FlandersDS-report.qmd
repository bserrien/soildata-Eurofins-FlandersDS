...
The graphs below show a scatter plot and loess smoother for the parameter measured with LUCAS vs. the Cmon (weighted average). The bisector is added for reference. Detection of outliers is performed with the Minimum Covariance Determinant (robust outlier detection; `performance` package).
...
# apply function
compare_schemes("Sand")
compare_schemes("Silt")
compare_schemes("Clay")
compare_schemes("TC")
compare_schemes("TOC")
compare_schemes("TIC")
compare_schemes("TN")
compare_schemes("pH_KCl_v_v")
compare_schemes("pH_KCl_m_v")
compare_schemes("pH_H20_m_v")
compare_schemes("pH_H20_v_v")
compare_schemes("pH_CaCl2_m_v")
compare_schemes("pH_CaCl2_v_v")
compare_schemes("EC_m_v")
compare_schemes("EC_v_v")
```
